class LangEn {
  static const map = {
    ...
    "how_to_use_desc": "Run the scanner, point at the code, not too close, so that there is empty space around the code. Do not scan diagonally.",
"scan_hints_desc": "Ensure the camera is not too close, there is good light, and the camera is in focus.",


    // Privacy Policy
    'privacy_policy': 'Privacy Policy',
    'license_and_copyright': 'License and Copyright',
    'privacy_intro_title': 'We do not collect any personal information',
    'privacy_intro_text':
    ...
    'data_disclaimer_text':
        ...
        'services, or applications. For example, if you use sharing features to send a message or post '
        'on a social network, the information you send will be visible to others. '
        'To understand how other sites handle your information, please refer to their privacy policies. '
        'This Privacy Statement does not apply to any decoded QR or barcode data.',
    'changes_policy': 'Changes to this Policy',
    'changes_policy_text':
        'This policy may be revised at any time. By using our site or applications, you accept the revised policy. '
        'We encourage you to periodically review this policy to understand how we protect your information.',
    'license_text':
    ...
    'vibrate': 'Vibrate',
    'vibrate_desc': 'Vibrate on successful scan',
    'beep': 'Beep',
    'beep_desc': 'Beep on successful scan',
    'history_desc': 'Save history of your scans',
       // Scan QR scanner
       "scan_instruction": "Position the code within the frame to scan",
// appoveed
"chauffeur_partner": "Chauffeur Partner Yeyo",
// not approved 
